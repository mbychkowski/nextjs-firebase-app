...
_GCP_SA_BUILD="sa-build"
_GCP_SA_DEPLOY_AUTO="sa-deploy-auto"
_GCP_SA_DEPLOY_EXEC="sa-deploy-exec"
...
GCP_SA_BUILD="${_GCP_SA_BUILD}"
GCP_SA_DEPLOY_AUTO="${_GCP_SA_DEPLOY_AUTO}"
GCP_SA_DEPLOY_EXEC="${_GCP_SA_DEPLOY_EXEC}"
